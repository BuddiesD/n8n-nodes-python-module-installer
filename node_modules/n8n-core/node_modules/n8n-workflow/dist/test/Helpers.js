...
class CredentialsHelper extends src_1.ICredentialsHelper {
    ...
    async getDecrypted(nodeCredentials, type) {
        return {};
    }
...
function getExecuteFunctions(workflow, runExecutionData, runIndex, connectionInputData, inputData, node, itemIndex, additionalData, mode) {
    return ((workflow, runExecutionData, connectionInputData, inputData, node) => {
        return {
            ...
            getWorkflowDataProxy: (itemIndex) => {
                const dataProxy = new src_1.WorkflowDataProxy(workflow, runExecutionData, runIndex, itemIndex, node.name, connectionInputData, {}, mode, additionalData.timezone, {});
