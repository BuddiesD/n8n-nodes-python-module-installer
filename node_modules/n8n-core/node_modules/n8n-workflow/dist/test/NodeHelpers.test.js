...
describe('Workflow', () => {
    describe('getParameterValue', () => {
        const tests = [
            ...
            {
                description: 'complex type "collection" which contains a "fixedCollection" with "multipleValues: false" that has a collection value added but nothing to the fixedCollection',
                input: {
                    nodePropertiesArray: [
                        {
                            displayName: 'Options',
...
//# sourceMappingURL=NodeHelpers.test.js.map